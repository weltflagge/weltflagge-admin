...
import { resetOrderProduction, updateOrderArchiveStatus, updateOrderEditableFields, updateOrderItemDetails, updateOrderItemPrintFile, updateOrderTracking, updateOrderWorkflowStatus } from "./actions";
...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <OrderDetailWorkspace
      ...
      onItemEdit={updateOrderItemDetails}
